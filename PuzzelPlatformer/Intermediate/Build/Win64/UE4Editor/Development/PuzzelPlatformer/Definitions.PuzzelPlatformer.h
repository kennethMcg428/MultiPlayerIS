...
#define ORIGINAL_FILE_NAME "UE4Editor-PuzzelPlatformer.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME PuzzelPlatformer
#define DEPRECATED_FORGAME DEPRECATED
#define PUZZELPLATFORMER_API DLLEXPORT
